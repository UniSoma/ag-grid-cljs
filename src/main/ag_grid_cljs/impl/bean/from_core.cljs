...
;; Vendored verbatim from cljs-bean 1.9.0 (cljs-bean.from.cljs.core), renamed
;; to ag-grid-cljs.impl.bean.from-core. See THIRD-PARTY.md. EPL-1.0 (retained).

(ns ^:no-doc ag-grid-cljs.impl.bean.from-core)
