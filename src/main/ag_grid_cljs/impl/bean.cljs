;   Copyright (c) Mike Fikes and Contributors. All rights reserved.
;   The use and distribution terms for this software are covered by the
;   Eclipse Public License 1.0 (http://opensource.org/licenses/eclipse-1.0.php)
;   which can be found at https://github.com/mfikes/cljs-bean.
;   By using this software in any fashion, you are agreeing to be bound by
;   the terms of this license.
;   You must not remove this notice, or any other, from this software.

;; Vendored from cljs-bean 1.9.0 (cljs-bean.core), renamed to
;; ag-grid-cljs.impl.bean so the shipped library carries zero runtime deps
;; beyond the AG Grid peer packages (ADR 0005 §8). The rename also avoids a
;; version clash with consumers using cljs-bean directly. Code body unchanged
;; from upstream; the ns/require were renamed, ^:no-doc added, and the EPL-1.0
;; notice above added (upstream cljs-bean.core carries no per-file header, but
;; the project is EPL-1.0 licensed). See THIRD-PARTY.md.

(ns ^:no-doc ag-grid-cljs.impl.bean
  (:require
   [ag-grid-cljs.impl.bean.from-core :as core]
   [goog.object :as gobj]))
