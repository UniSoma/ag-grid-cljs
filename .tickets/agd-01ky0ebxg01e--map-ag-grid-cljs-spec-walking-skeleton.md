...
updated: '2026-07-22T01:28:43.254107145Z'
tags:
- wayfinder:map
---
...
- Docs/cljdoc strategy for the curated builders (the generated kebab↔camel reference table is resolved — committed `docs/reference/ag-grid-options.md`, see the key-registry ticket). Now also owns the framework-composition recipe page (Reagent/UIx + reactive-seams pointer) from the adapters decision.
