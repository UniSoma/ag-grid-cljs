...
updated: '2026-07-22T18:56:26.731923633Z'
closed: '2026-07-22T18:56:26.731923633Z'
acceptance:
...
**2026-07-22T18:56:26.731923633Z**

create-grid! returns a GridHandle {:api :opts} record stashing unconverted EDN opts (ADR 0008); grid-api accessor exposes the raw GridApi (ADR 0004); set-rows!/transact!/destroy! retargeted to the handle. Three dev apps updated to the new entry point (all compile). Full docstring contracts (ADR 0014) on every touched public var. New core_test.cljs covers accessor + channel dispatch DOM-free; suite green (18 tests, 43 assertions). update-grid! left to follow-up agd-01ky5hj32e7j.
